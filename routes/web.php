...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('profile/{id}/{memberId}', [adminProfileController::class, 'index'])->name('profile');
...
Route::get('/get-districts/{selectedOption}', [DistrictsController::class, 'getDistricts'])->name('getDistricts');
Auth::routes();
